...
public class EfficientDocument extends Document {
	...
	private void processText()
	{
		...
		//System.out.println(String.format("\nnumSentences = %d, numWords = %d, numSyllables = %d", numSentences, numWords, numSyllables));
	}
	...
	public static void main(String[] args)
	{
		...
		//EfficientDocument d = new EfficientDocument("This is a test.  How many???  Senteeeeeeeeeences are here... there should be 5!  Right"); // 5-13-16
	}
}